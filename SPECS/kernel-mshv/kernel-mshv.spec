...
%build
make VERBOSE=1 V=1 KBUILD_VERBOSE=1 KBUILD_BUILD_VERSION="1" KBUILD_BUILD_HOST="CBL-Mariner" ARCH=%{arch} %{_smp_mflags} --output-sync=target
...
%changelog
* Mon Apr 28 2025 Saul Paredes <saulparedes@microsoft.com> - 5.15.157.mshv1-4
- Group logs by parallel job to improve readability
